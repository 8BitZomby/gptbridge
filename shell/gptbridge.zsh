...
#
# Installs only inside a shell launched and managed by gptbridge.
...
# Install the integration only inside a managed gptbridge shell. Keeping the
# integration inside this conditional avoids returning from the user's .zshrc
